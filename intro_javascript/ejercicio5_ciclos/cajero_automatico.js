alert("Bienvenido a TuBancoFavorito. Seguridad al 100%");
var cliente ={
    nombre:"Ronny",
    apellido:"Reyes",
    edad:21,
...
while (tarjeta.length !== 6) {
    tarjeta = prompt("Introdusca una tarjeta de 6 digitos")
}

// validar que la tarjeta ingresada coincida con la mia

while (tarjeta != cliente.tarjeta) {
    tarjeta = prompt("Tarjeta no encontrada. Intentelo de nuevo:");
}
